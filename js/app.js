...
window.onload = function () {
	...
	`;
		...
		<div data-goto=".map" class="item-product__actions actions-product">
			<div class="actions-product__body">
				<a data-goto=".map" href="" class="actions-product__button btn btn_white">Забронировать</a>
			</div>
		</div>
	`;
...
const footerMenuLinks = document.querySelectorAll('.menu-footer__link[data-goto]');
if (footerMenuLinks.length > 0) {
	...
	function onFooterMenuLinkClick(e) {
		...
		if(footerMenuLink.dataset.goto && document.querySelector(footerMenuLink.dataset.goto)) {
			const gotoBlock = document.querySelector(footerMenuLink.dataset.goto);
			const gotoBlockValue = gotoBlock.getBoundingClientRect().top + scrollY - document.querySelector('header').offsetHeight;
